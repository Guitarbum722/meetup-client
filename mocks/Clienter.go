...
import meetup "github.com/Guitarbum722/meetup-client"
...
func (_m *Clienter) CommentOnEvent(_a0 meetup.eopts, _a1 map[string][]string) (*models.Comment, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *models.Comment
	if rf, ok := ret.Get(0).(func(meetup.eopts, map[string][]string) *models.Comment); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(meetup.eopts, map[string][]string) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *Clienter) CreateEvent(_a0 meetup.eopts, _a1 map[string][]string) (*models.Event, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *models.Event
	if rf, ok := ret.Get(0).(func(meetup.eopts, map[string][]string) *models.Event); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Clienter) EventComments(_a0 meetup.eopts, _a1 map[string][]string) (*models.Comments, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *models.Comments
	if rf, ok := ret.Get(0).(func(meetup.eopts, map[string][]string) *models.Comments); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Clienter) EventRatings(_a0 meetup.eopts, _a1 map[string][]string) (*models.Ratings, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *models.Ratings
	if rf, ok := ret.Get(0).(func(meetup.eopts, map[string][]string) *models.Ratings); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Clienter) RateEvent(_a0 meetup.eopts, _a1 map[string][]string) (*models.Rating, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *models.Rating
	if rf, ok := ret.Get(0).(func(meetup.eopts, map[string][]string) *models.Rating); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Clienter) UpdateEvent(_a0 string, _a1 meetup.eopts, _a2 map[string][]string) (*models.Event, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 *models.Event
	if rf, ok := ret.Get(0).(func(string, meetup.eopts, map[string][]string) *models.Event); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.Event)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, meetup.eopts, map[string][]string) error); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		r1 = ret.Error(1)
	}
